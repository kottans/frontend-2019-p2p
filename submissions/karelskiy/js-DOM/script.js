class iPhone {
  constructor(model, description, cost, img) {
    this.model = model;
...
const phone = [
  ...
  new iPhone(
    'iPhone 8',
    '4.7-inch Retina HD display with True Tone. IP67 water and dust resistant (maximum depth of 1 meter up to 30 minutes). 12MP camera with OIS and 4K video. 7MP FaceTime HD camera with Retina Flash. Touch ID for secure authentication. A11 Bionic with Neural Engine. iOS 12 with Screen Time, Group FaceTime, and even faster performance. ',
    'Starting at $449',
    './img/eight.jpeg'
  )
]
