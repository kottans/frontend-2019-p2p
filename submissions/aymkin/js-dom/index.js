...
eventTarget.addEventListener("click", evt => {
  const clickedOn = evt.target.textContent;
  ...
  switch (clickedOn) {
    case "Orange":
      ...
      break;
    case "Banana":
      image.setAttribute("src", fruits[1].imgSrc);
      descriptionHeader.textContent = fruits[1].name;
      descriptionParah.textContent = fruits[1].description;
      break;
    case "Grape":
      image.setAttribute("src", fruits[2].imgSrc);
      descriptionHeader.textContent = fruits[2].name;
      descriptionParah.textContent = fruits[2].description;
      break;
    case "Pear":
      image.setAttribute("src", fruits[3].imgSrc);
      descriptionHeader.textContent = fruits[3].name;
      descriptionParah.textContent = fruits[3].description;
      break;
    case "Durian":
      image.setAttribute("src", fruits[4].imgSrc);
      descriptionHeader.textContent = fruits[4].name;
      descriptionParah.textContent = fruits[4].description;
      break;
  }
});
