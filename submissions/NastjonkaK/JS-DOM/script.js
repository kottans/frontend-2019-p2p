const countries = [
  {
    id: "1",
    name: "Австрія",
    img: "linear-gradient(rgba(0,0,0, 0.7), rgba(0,0,0, 0.7)), url(Sourse/Austria.jpg)",
    description:
    ...
    },
  {
    id: "2",
    name: "Італія",
    img: "linear-gradient(rgba(0,0,0, 0.7), rgba(0,0,0, 0.7)), url(Sourse/Italy.jpg)",
    description:
  ...
  },
  {
    id: "3",
    name: "Нідерланди",
    img: "linear-gradient(rgba(0,0,0, 0.7), rgba(0,0,0, 0.7)), url(Sourse/Netherlands.jpg)",
    description:
  ...
  },
  {
    id: "4",
    name: "Чехія",
    img: "linear-gradient(rgba(0,0,0, 0.7), rgba(0,0,0, 0.7)), url(Sourse/CzechRepublic.jpg)",
    description:
  ...
  },
  {
    id: "5",
    name: "Хорватія",
    img: "linear-gradient(rgba(0,0,0, 0.7), rgba(0,0,0, 0.7)), url(Sourse/Croatia.jpg)",
    description:
...
function changeContent (el){
	let country = countries.find(obj => obj.id === el.target.id);
  ...
  container.style.backgroundImage = country.img;
};
